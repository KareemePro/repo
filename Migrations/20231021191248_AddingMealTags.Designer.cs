...
namespace FoodDelivery.Migrations
{
    ...
    [Migration("20231021191248_AddingMealTags")]
    partial class AddingMealTags
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealTag", b =>
                {
                    b.HasOne("FoodDelivery.Models.DominModels.Meal", null)
                        .WithMany()
                        .HasForeignKey("MealID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDelivery.Models.DominModels.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
